...
- 既存の [circleci/aws-cli](https://circleci.com/developer/ja/orbs/orb/circleci/aws-cli) や [circleci/gcp-cli](https://circleci.com/developer/ja/orbs/orb/circleci/gcp-cli) といった CircleCI 公式の Orb はまだ OIDC サポートされていないため、認証は自前でスクリプトを書く必要があります
  ...
  - 一応すでに PR や issue があります
    - [aws-cli-orb の PR](https://github.com/CircleCI-Public/aws-cli-orb/pull/101)
    - [gcp-cli-orb の issue](https://github.com/CircleCI-Public/gcp-cli-orb/issues/41)
...
## [AWS Lambda が単体でHTTPSエンドポイントを持てるようになりました](https://aws.amazon.com/jp/blogs/news/announcing-aws-lambda-function-urls-built-in-https-endpoints-for-single-function-microservices/)
共有担当: [@ganta0087](https://twitter.com/ganta0087)
